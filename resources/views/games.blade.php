...
@section('content')
    <main class="homepage">
        <div class="container">
            ...
            Adipisci dignissimos corrupti quisquam neque, pariatur fuga, sequi architecto possimus atque minus consectetur iure commodi vel ducimus modi necessitatibus. Rerum explicabo delectus ullam ut magnam, ea nulla quibusdam quam officia!
            Voluptatibus dolor quas ducimus iste praesentium? Aut totam nulla autem illo ipsam pariatur maiores provident praesentium in! Aperiam quibusdam reprehenderit voluptate? Nostrum dicta quos, adipisci sapiente asperiores voluptatibus ea veritatis?</p>
        </div>
    </main>
@endsection
